public class Tanque {
    ...
    public boolean disparo(double velocidad, double angulo, Mapa mapa,  double gravedad, int viento, int dirViento){
        /*
        ...
        */
        ...
        return (bala.calcularLanzamiento(bala, velocidad, angulo, mapa, gravedad, viento,dirViento)==1);
    }
